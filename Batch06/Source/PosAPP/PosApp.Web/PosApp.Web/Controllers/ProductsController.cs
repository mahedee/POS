...
namespace PosApp.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Measurement).Include(p => p.Shop);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Stock,BarCode,ShopId,MeasurementId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Stock,BarCode,ShopId,MeasurementId")] Product product)
        {
            if (ModelState.IsValid)
            {
