...
namespace POS.Controllers
{
    public class CompanyInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyCode,CompanyName,Address,ShortName")] CompanyInfo companyInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CompanyCode,CompanyName,Address,ShortName")] CompanyInfo companyInfo)
        {
            if (ModelState.IsValid)
            {
